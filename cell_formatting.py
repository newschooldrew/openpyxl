...
for row in ws1.iter_rows(min_row=1,max_col=10,max_row=10):
    for cell in row:
        cell.value = counter
        counter += 1
...
font_cell.font = Font(name='Arial',size=18,b=True,i=True, color=colors.COLOR_INDEX[15])
